...
public class PumpBall {
	...
	public PumpBall(float radius, int quality, float r, float g, float b) {
		float vertices[];
		final float vertices1[] = new float[3];
		final float vertices2[] = new float[3];
		final float vertices3[] = new float[3];
		float theta1, theta2;
